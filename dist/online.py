...
class App:
    def __init__(self):
        ...
        self.image2 = tk.PhotoImage(file='pngegg (1).png')
        ...
        self.label3 = tk.Label(self.Splashwindow, text='CLINICAL INFORMATION RETRIEVAL SYSTEM',
                                   bg='white', fg='red', font=('Times', 20))
        self.label3.place(relx=0.5, rely=0.7, anchor=tk.CENTER)

        self.Splashwindow.after(2000,self.loginwindow)
        #self.loginwindow()
    ...
    def mainwindow(self):
        ...
        top_large=ctk.CTkFrame(self.main_window, fg_color='#ff7b7b', width=300,
        ...
        imageskullabel=tk.Label(top_large,image=self.imageskul ,bg='#ff7b7b')
        ...
        self.image4 = Image.open('pngegg4.png')
        ...
        self.labelmaintext = tk.Label(self.mainframe1, text='GOOD HEALTH IS GOOD WEALTH!',
                                      bg='#ecebe9', fg='#ff7b7b', font=('Times', 20))
        self.labelmaintext.place(relx=0.57, rely=0.8, anchor=tk.CENTER)
    ...
    def toggle(self):
        ...
        self.dropdown_frame=ctk.CTkFrame(self.dropdownDisguise_frame,fg_color="#ff7b7b",height=600,width=300,corner_radius=10,border_width=2)
        ...
        self.button_Home.place(relx=0.05, rely=0.5)
        #command=self.home
        ...
        self.button_register.place(relx=0.1, rely=0.1)
        #command = self.info
    ...
    def home(self):
        ...
        style.configure('Treeview.Heading', font=('Arial', 10,), background='#ff7b7b', foreground='white')
    ...
    def info(self):
        ...
        mini2_of_6 = ctk.CTkFrame(self.largeframe6, fg_color='white', width=500, height=280,
                                  corner_radius=10, border_color='#173662',
                                  border_width=0)
        # self.largeframe3.place(relx=0.01, rely=0.01)
        mini2_of_6.pack(side='left', fill='both', expand=True,padx=10, pady=10)
    ...
    def connectDatabase(self):
        try:
            self.con = pymysql.connect(
                host='sql5.freesqldatabase.com',  # typically 'localhost' or an IP address
                user='sql5732003',  # correct parameter name is 'user', not 'role'
                password='vcadnSiQbd'
            )
        ...
        try:
            self.mycursor.execute('CREATE DATABASE IF NOT EXISTS sql5732003')
            self.mycursor.execute('USE  sql5732003')
    ...
    def check(self):
       ...
       try:
           ...
           if len(self.list1)==0:
               ...
               self.backbut = CTkButton(self.mini2, text='BACK', fg_color='#ff7b7b',
                                       text_color='white', height=35, width=80,
    ...
    def plot_gender_distribution_in_frame(self):
        try:
            ...
            for row in result:
                labels.append(row[0])  # Gender (Male/Female)
                sizes.append(row[1])  # Count
